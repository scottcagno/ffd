...
<div class="boxedcontent">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 negmtop">
				<h1 class="pgheadertitle animated fadeInLeft pull-left">Icons</h1>
	...
	<div class="container">
		...
		<div class="titleborder center"><div><h1>Web Applications</h1></div></div>
		...
		<div class="titleborder center"><div><h1>Form Control Icons</h1></div></div>
		<div class="row fontawesome-icon-list">
		<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-check-square"></i> fa-check-square</div>
		<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-check-square-o"></i> fa-check-square-o</div>
		<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-circle"></i> fa-circle</div>
		...
		<br/>
		<section id="currency">
		<div class="titleborder center"><div><h1>Currency Icons</h1></div></div>
		<div class="row fontawesome-icon-list">
		...
		<div class="titleborder center"><div><h1>Text Editor Icons</h1></div></div>
		<div class="row fontawesome-icon-list">
		...
		<div class="titleborder center"><div><h1>Directional Icons</h1></div></div>
		<div class="row fontawesome-icon-list">
		...
		<div class="titleborder center"><div><h1>Video Player Icons</h1></div></div>
		<div class="row fontawesome-icon-list">
		<div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-arrows-alt"></i> fa-arrows-alt</div>
		...
		<br/>
		<section id="brand">
		<div class="titleborder center"><div><h1>Brand Icons</h1></div></div>
		<div class="row fontawesome-icon-list">
		...
		<br/>
		<section id="medical">
		<div class="titleborder center"><div><h1>Medical Icons</h1></div></div>
		<div class="row fontawesome-icon-list">
