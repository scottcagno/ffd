	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 negmtop">
				<h1 class="pgheadertitle animated fadeInLeft pull-left">Testimonials</h1>
				<span class="pagedescrarea text-right animated fadeInRight pull-right">
				<i>Loyal client? Add your own testimonial <a href="big-map-contact.html">here</a>!</i>
				</span>
			</div>
		</div>
	</div>
		...
		<div id="content" class="ptop10">
			...
			<div class="boxportfolio3">
				...
				<div class="author-wrapper">
					...
					<div class="testimonial-name fontbold">
						 William Shakepseare <span>Writer</span>
					</div>
				</div>
			</div>
			<!-- box -->
			...
			<div class="boxportfolio3">
				...
				<div class="author-wrapper">
					...
					<div class="testimonial-name fontbold">
						 Albert Einstein <span>Real One</span>
					</div>
				</div>
			</div>
			<!-- box -->
			...
			<div class="boxportfolio3">
				...
				<div class="author-wrapper">
					...
					<div class="testimonial-name fontbold">
						 Marky S <span>Brilliant Mind</span>
					</div>
				</div>
			</div>
			<!-- box -->
			...
			<div class="boxportfolio3">
				...
				<div class="author-wrapper">
					...
					<div class="testimonial-name fontbold">
						 Albert Einstein <span>Genious</span>
					</div>
				</div>
			</div>
			<!-- box -->
			...
			<div class="boxportfolio3">
				...
				<div class="author-wrapper">
					...
					<div class="testimonial-name fontbold">
						 Jerry Seinfeld <span>Comediant</span>
					</div>
				</div>
			</div>
			<!-- box -->
			...
			<div class="boxportfolio3">
				...
				<div class="author-wrapper">
					...
					<div class="testimonial-name fontbold">
						 Ellen DeGeneres <span>Manager</span>
					</div>
				</div>
			</div>
			<!-- box -->
			...
			<div class="boxportfolio3">
				...
				<div class="author-wrapper">
					...
					<div class="testimonial-name fontbold">
						 Clarence Darrow <span>Scopes trial, 1925</span>
					</div>
				</div>
			</div>
			<!-- box -->
