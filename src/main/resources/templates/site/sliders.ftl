	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 negmtop">
				<h1 class="pgheadertitle animated fadeInLeft pull-left">Sliders</h1>
		...
		<div class="row">
			<div class="col-md-12">					
					...
					<div class="fullwidth flexslider" id="basic-slider">
						<ul class="slides">
							<li><img src="http://www.wowthemes.net/demo-asher/wp-content/uploads/sites/9/2014/02/asherslider2.jpg" alt="slide"></li>
							<li><img src="http://www.wowthemes.net/demo-asher/wp-content/uploads/sites/9/2014/02/wordpressthemeasher3.jpg" alt="slide"></li>
						</ul>
					</div>
					<!-- end image slider -->
