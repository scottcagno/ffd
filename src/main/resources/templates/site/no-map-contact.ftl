					...
					<div class="shortcode row">
						...
						<div class="col-md-5">
							<div class="box1">
								...
								<h6><i class=" fa fa-map-marker "></i> Contacts </h6>
								...
								<i class="fa fa-mobile-phone"></i> &nbsp;<i>Mobile</i>: +1 348 271 9483<br/><br/>
								<i class="fa fa-phone"></i> <i>Telephone</i>: +1 243 794 5734<br/><br/>
								<i class="fa fa-envelope"></i> <i>E-mail</i>: <a href="mailto:wowthemesnet@gmail.com">wowthemesnet@gmail.com</a>
								<span class="boxlink "><a href=" mailto:wowthemesnet@gmail.com " class="defaultbutton mainthemebgcolor"><i class="fa fa-link"></i></a></span>
							</div>
						</div>
					</div>
