...
<div class="boxedcontent">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 negmtop">
				<h1 class="pgheadertitle animated fadeInLeft pull-left">Knowledge Base</h1>
	...
	<div class="container">
		<div class="shortcode row">
			...
			<div class="col-md-6">
				<h1 class="fancybox2 title fontregular"><i class="fa fa-tags "></i> Presale Questions (5) </h1>
				<div class="fancybox2">
					<div class="toggle">
					...
					<div class="toggle_content">
						<span class="tc">Nam eget dui. Etiam rhoncus. Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu. In enim justo, rhoncus ut, imperdiet a, venenatis vitae, justo. Nullam dictum felis eu pede mollis pretium. Integer tincidunt. Cras dapibus. Vivamus elementum semper nisi. Aenean vulputate eleifend tellus. Maecenas tempus, tellus eget condimentum rhoncus, sem quam semper libero, sit amet adipiscing sem neque sed ipsum. Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu. In enim justo, rhoncus ut, imperdiet a, venenatis vitae, justo.</span>
					</div>
					<div class="toggle">
			...
			<div class="col-md-6">
				<h1 class="fancybox2 title fontregular"><i class="fa fa-tasks "></i> Client Requirements (5) </h1>
				<div class="fancybox2">
					<div class="toggle">
						Donec pede justo, fringilla vel, aliquet nec?
					</div>
		...
		<div class="shortcode row">
			...
			<div class="col-md-6">
				<h1 class="fancybox2 title fontregular"><i class="fa fa-flag "></i> Technical Support (5) </h1>
				<div class="fancybox2">
					<div class="toggle">
						Donec pede justo, fringilla vel, aliquet nec?
					</div>
			...
			<div class="col-md-6">
				<h1 class="fancybox2 title fontregular"><i class="fa fa-tint "></i> Terms of Use (5) </h1>
				<div class="fancybox2">
					<div class="toggle">
						Donec pede justo, fringilla vel, aliquet nec?
					</div>
		...
		<div class="panel1">
			<div class="col-md-9">
				<h4>YOUR QUESTION NOT ON THE LIST?</h4>
				 Aliquam convallis, urna vel luctus consequat, urna leo adipiscing sapien, mattis molestie nulla augue sed elit. Pellentesque interdum mi non dolor facilisis porta. Cras venenatis dolor sed magna rhoncus non fermentum.<br/>
			</div>
			<div class="col-md-3">
				<a href="#" class="sbutton square noshadow medium mainthemebgcolor"><i class="fa fa-comment"></i> Contact us now</a>
			</div>
			<div class="clearfix">
			</div>
		</div>
