	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 negmtop">
				<h1 class="pgheadertitle animated fadeInLeft pull-left">Icon Lists</h1>
				<span class="pagedescrarea text-right animated fadeInRight pull-right">
				<i>Stylish your lists with some beautiful icons</i>
				</span>
			</div>
		</div>
	</div>
			...
			<div class="row">
				<div class="col-md-3 footer-widget">
					...
					<div class="textwidget">
						<p>
							 Introducing a premium Bootstrap Theme for multipurpose use.
						</p>
						<p>
				...
				<div class="col-md-3 footer-widget">
					...
					<div class="textwidget">
						<div id="quotes">
							<div class="textItem">
								<div class="avatar">
									<img src="http://www.wowthemes.net/demo/biscaya/img/demo/test2.gif" alt="Antoine de Saint-Exupery ">
								</div>
								<p>
							...
							<div class="textItem">
								<div class="avatar">
									<img src="http://www.wowthemes.net/demo/biscaya/img/demo/test1.png" alt="Paul Rand ">
								</div>
								<p>
